...
final class Branches
{
    ...
    {
        return array_map(function (array $listResponse) use ($repository): Branch {
            $detailResponse = $this->get($repository, $listResponse['name']);

            return Branch::fromResponse($detailResponse);
